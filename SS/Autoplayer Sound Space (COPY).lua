...
local r = getupvalue(u.ClearNotes, 1); --static var for the cube table
local updateSaber = u.UpdateSaber;
local cubeTree = {}; --setmetatable({}, { __mode = 'v' }); --priority queue (similar to a stack this case) for cubes
